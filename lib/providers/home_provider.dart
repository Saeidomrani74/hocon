...
class HomeProvider extends ChangeNotifier {
  ...
  Future<void> activateDevice() async {
    ...
    sendSMSResult.fold(
      ...
      (r) async {
        _mainProvider.startSMSCooldown();
        if (_mainProvider.selectedDevice.deviceState != 'active') {
          await _mainProvider.updateDevice(
            _mainProvider.selectedDevice.copyWith(deviceState: 'active'),
          );
        }
      },
    );
  ...
  Future<void> deactiveDevice() async {
    var smsCode = smsCodeGenerator(
      _mainProvider.selectedDevice.devicePassword,
    ...
    sendSMSResult.fold(
      ...
      (r) async {
        _mainProvider.startSMSCooldown();
        if (_mainProvider.selectedDevice.deviceState != 'deactive') {
          await _mainProvider.updateDevice(
            _mainProvider.selectedDevice.copyWith(deviceState: 'deactive'),
          );
        }
      },
    );
  ...
  Future<void> semiActiveDevice() async {
    var smsCode = smsCodeGenerator(
      _mainProvider.selectedDevice.devicePassword,
    ...
    sendSMSResult.fold(
      ...
      (r) async {
        _mainProvider.startSMSCooldown();
        if (_mainProvider.selectedDevice.deviceState != 'semi_active') {
          await _mainProvider.updateDevice(
            _mainProvider.selectedDevice.copyWith(deviceState: 'semi_active'),
          );
        }
      },
    );
